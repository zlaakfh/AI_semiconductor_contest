...
**`주제 : YOLOv5/YOLOv8을 이용하여 차량 주행 영상으로부터 NPU 환경에서 다중 객체에 대한 실시간 탐지 성능 평가`** <br>
...
- YOLOv8s
    ...
    > - Backbone : 입력 이미지로부터 특징(Feature)을 추출하는 역할
    > - Neck : 이미지로부터 추출된 여러 크기의 특징(Feature)들을 결합하는 역할
